        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <ul class="layui-tab-title">
                <span  v-for="(item,index) in spdataList" v-bind:key="index">
                    <li @click="pageListfenlei(item.shangpinfenlei)">{{ item.shangpinfenlei }}</li>
                </span>
            </ul>
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="guige" id="guige" placeholder="商品分类" autocomplete="off" class="layui-input">
              </div>
            </div>   
  ...
  <script>
    var vue = new Vue({
      ...
      methods: {
        ...
        pageListfenlei(shangpinfenlei){
            var status = null;
            layui.http.request('shangpinxinxi/list', 'get', {
                page: 1,
                limit: 6,
